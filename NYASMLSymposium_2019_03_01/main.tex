...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	A $\Dir{\bm{\alpha}}$ sample can be generated by normalizing $\Gam{\alpha_k,1}$ samples. We compare the variance of the gradient of our method to competing methods \cite{ref:grad_reparam} through use of their code \cite{ref:grad_reparam_code}.
	\begin{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	Perplexity scores after replacing the softmax MC sampler of \cite{ref:neural_lda_code} with ours.
	\vspace{-5pt}
	\begin{center}
	\small
  	\begin{tabular}{ccc}
