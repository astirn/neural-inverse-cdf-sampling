...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\noindent A $\Dir{\bm{\alpha}}$ sample can be generated by normalizing $\Gam{\alpha_k,1}$ samples. We compare the variance of the gradient of our method to orther reparameterization methods \cite{ref:grad_reparam} using their code \cite{ref:grad_reparam_code}.
	\begin{center}
