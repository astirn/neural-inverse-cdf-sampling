...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \noindent For continuous univariate distribution, inverse CDF sampling allows us to reparameterize a sample from a Uniform distribution to the target distribution:
	\begin{equation*}
	\begin{aligned}
		\epsilon &\sim \Uni{0,1}\\
		z &= F^{-1}(\epsilon; \ \theta) 
...
are the outputs of multi-layer perceptrons operating on the distribution parameters $\theta$. Define loss as $|F(z_i; \ \theta_n) - \hat{F}(z_i; \ \theta_n)|$.}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\noindent A $\Dir{\bm{\alpha}}$ sample can be generated by normalizing $\Gam{\alpha_k,1}$ samples. We compare the variance of the gradient of our method to competing methods \cite{ref:grad_reparam} through use of their code \cite{ref:grad_reparam_code}.
	\begin{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\noindent Perplexity scores after replacing the Gaussian-softmax sampler \cite{ref:neural_lda_code} with ours.
	\vspace{-10pt}
	\begin{center}
	\small
  	\begin{tabular}{ccc}
